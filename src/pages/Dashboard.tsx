      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-zinc-900 border border-white/10 rounded-3xl p-8">
          ...
          <div className="flex items-center gap-6">
            <img src={userProfile.avatarUrl} className="w-20 h-20 rounded-full object-cover border-2 border-white/10" alt="" />
            <div className="flex-1">
              <input
                type="text"
                value={userProfile.avatarUrl}
                onChange={(e) => updateProfile({ avatarUrl: e.target.value })}
                className="w-full bg-black border border-white/10 rounded-xl py-2 px-4 outline-none focus:border-blue-500 transition-colors text-sm"
        ...
        <div className="bg-zinc-900 border border-white/10 rounded-3xl p-8">
          ...
          <div className="space-y-4">
             <div className="h-20 w-full bg-zinc-800 rounded-xl overflow-hidden">
                <img src={userProfile.bannerUrl} className="w-full h-full object-cover" alt="" />
             </div>
             <input
                type="text"
